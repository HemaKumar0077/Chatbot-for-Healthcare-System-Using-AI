...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Health Care Chatbot", bg="lightblue", width="30", height="2", font=("Calibri", 13))
        self.lblMsg.pack()
        ...
        self.lblTeam=Label(self, text="Made by:", bg="lightgray", width = "25", height = "1", font=("Calibri", 13))
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="PM HEMA KUMAR REDDY", bg="lightgray", width = "25", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="POOJITHA REDDY DS", bg="lightgray", width = "25", height = "1", font=("Calibri", 13))
        self.lblTeam2.pack()
